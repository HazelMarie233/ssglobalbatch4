...
public class TestMathOp {
	...
	@Test
	public void testDivideNew() { // new fail
		int expectValue = 0;
	...
	public static Stream<DivideParams> createParams() { //Method source of createParams
		return Stream.of(new DivideParams(10, 10, 1), new DivideParams(-10, 5, -2), new DivideParams(3, 0, 0));
	}
